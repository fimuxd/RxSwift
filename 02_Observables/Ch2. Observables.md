...
<img src = "https://github.com/fimuxd/RxSwift/blob/master/02_Observables/2.%20lifecycle1.png?raw=true" height = 50>

* 이 Observable은 세 개의 tap 이벤트를 방출한 뒤 완전종료됨. 이 것을 앞서 말한 대로 `completed` 이벤트라고 한다.

<img src = "https://github.com/fimuxd/RxSwift/blob/master/02_Observables/3.%20lifecycle2.png?raw=true" height = 50>
